...
### Code Writing Standards
    ...
    - Avoid code duplication (DRY principle); reuse code via functions, classes, modules, or libraries
    - Use comments sparingly and make them meaningful - explain "why" or unusual behavior, not obvious things
